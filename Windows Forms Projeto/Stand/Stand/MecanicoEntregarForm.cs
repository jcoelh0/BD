...
namespace Stand
{
    public partial class MecanicoEntregarForm : Form
    {
        private SqlConnection cn;
        private int current;

        public MecanicoEntregarForm(SqlConnection cn)
        {
            InitializeComponent();
            this.cn = cn;
            loadCarsToRepair() ;
        ...
        private void bttnReparar_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@Nr_Funcionario", ((VeiculoReparar)listBox1.Items[current]).Mecanico);

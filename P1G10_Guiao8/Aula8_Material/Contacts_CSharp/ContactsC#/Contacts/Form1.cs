...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            loadCustomersAutomatically();
        }


        private SqlConnection getSGBDConnection() 
        {
            return new SqlConnection("data source= localhost\\SQLEXPRESS;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void loadCustomersAutomatically()
        {
            if (!verifySGBDConnection())
                return;
